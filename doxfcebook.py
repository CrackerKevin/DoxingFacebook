...
print('Facil Doxing De Facebook Creado Por El Cracker Kevin/\n')
user_id = input("Ingresa ID Del Facebook Cracker: ")
...
print(green,"Grupos:",reset+"https://www.facebook.com/search/"+user_id+"/groups")
print(green,"Futuros Eventos:",reset+"https://www.facebook.com/search/"+user_id+"/events-joined/")
print(green,"Past events:",reset+"https://www.facebook.com/search/"+user_id+"/events-joined/in-past/date/events/intersect/")
print(green,"Videojuegos:",reset+"https://www.facebook.com/search/"+user_id+"/apps-used/game/apps/intersect")
...
print(green,"Restaurantes:",reset+"https://www.facebook.com/search/"+user_id+"/places-visited/273819889375819/places/intersect/")
...
print(green,"Hoteles:",reset+"https://www.facebook.com/search/"+user_id+"/places-visited/164243073639257/places/intersect/")
